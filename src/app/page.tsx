    ...
    <main className="min-h-screen flex flex-col items-center py-12 px-6 sm:px-12 relative z-10">
      ...
      >
        ...
        <motion.div 
          ...
          className="w-32 h-32 rounded-full bg-gradient-to-tr from-primary to-amber-300 p-1 mb-6 shadow-2xl shadow-primary/30 relative"
        >
        ...
        <div className="w-full flex flex-col gap-4 mb-12">
          {socialLinks.map((link, index) => (
            ...
            >
              ...
              <div className={`mr-4 text-foreground/80 transition-colors duration-300 ${link.color} relative z-10`}>
                {link.icon}
              </div>
